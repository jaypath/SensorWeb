...
#define FETCHED_WEATHER_AND_TEMP_FIELDS_COUNT 11 //Weather IDs for next 8 hours, current temp and temp in 4 hours, currentHour
...
typedef struct weather_info_t {
  ...
  void set_fields(long worst_weather_id_, double current_temp_, double next_temp_, double current_hour_) {
