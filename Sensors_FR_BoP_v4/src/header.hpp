...
const byte ASSIGNEDIP[4] = {0,0,0,0}; //assign here if this sensor has a dedicated IP. Else assign 0,0,0,0

#define ARDNAME "FRBoP"
#define SENSORNUM 1 //be sure this matches SENSORTYPES

const uint8_t SENSORTYPES[SENSORNUM] = {3}; //max is 8
...
#define _USESOILRES 33 //pin used for power... for esp32 use any adc1 such as 33 //for esp8266 D5 ////this is the pin that turns on to test soil... not to be confused with soilpin, the Analog in pin
